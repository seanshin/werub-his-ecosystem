...
function cardBody(from, to, list, human) {
  ...
  // 한 / 영 혼용 — 문서마다 영문 요약 한 덩이(번역이 아니라 요약)
  {
    ...
    L.push(`> **EN** — Integration contract card: **${from} → ${to}**. ${en} Config keys are listed by **name only** — values are generated by the institution. Authoritative status lives in the [connection table](../../RELEASES/draft/compatibility.md).`, '');
  }
