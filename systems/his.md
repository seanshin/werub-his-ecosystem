...
- **실제로 돌아간 기록** — 8개 시스템을 8코어 · 16GB 가상 서버 한 대에 함께 올린 운영 기록이 있습니다(2026-08-25 · 여유가 넉넉하지 않음). 권장 사양이 아니라 하한에 가까운 기록입니다([README](../README.md#최소한의-사양과-구현으로-쓸-수-있게)). HIS 단독 권장 사양은 새 설치본으로 따라가 보며 계측해 [구축 가이드](../build-guide/)에 싣습니다.
