...
| 02-02 | 분류 화면과 AI 분류 보조 제안(AI 표기와 면책 문구가 보이게) | HIS `응급실` | AI 기능을 켠 설치본 |
| 02-03 | 응급실 보드 | HIS `응급실 보드` | — |
| 02-04 | 위험치 통보 · 복창 기록 | LIS 위험치 | — |
| 02-05 | 영상 자동 선별 알림과 응급 보드 | PACS 응급 보드 | AI 기능을 켠 설치본 |
| 02-06 | Code Blue · 신속대응팀 호출 | HIS `Code Blue / RRT` | — |
| 02-07 | 응급 열람 사유 입력과 사후 검토 목록 | HIS `응급 접근 검토` | — |
