...
| 기준 | 값 |
|---|---|
| 원본 | [연결 상태 표](../RELEASES/draft/compatibility.md)(판정 2026-09-11 · 코드 대조 · 실제 호출 확인 없음) |
| 실은 연결 | 113 |
| 시스템 쌍 | 33 |

## 시스템 쌍별

| 쌍 | 연결 | 구현·미검증 | 설계만 | 미구현 | 중단 | 판정 불가 |
|---|---:|---:|---:|---:|---:|---:|
| HIS ⇄ ERP | 15 | 14 | · | 1 | · | · |
| HIS ⇄ LIS | 13 | 9 | · | 4 | · | · |
...
> `검증됨` 열은 **0 이라 싣지 않았습니다.** 실제로 호출해 확인한 연결이 아직 없습니다.
...
| 묶음 | 연결 | 구현·미검증 | 미구현 | 중단 | 판정 불가 | 설계만 |
|---|---:|---:|---:|---:|---:|---:|
| FHIR R4 | 9 | 9 | · | · | · | · |
| DICOM | 3 | 3 | · | · | · | · |
| HL7 v2 | 6 | 1 | 5 | · | · | · |
| ASTM | 1 | · | 1 | · | · | · |
| HTTPS REST | 52 | 42 | 7 | 2 | 1 | · |
| 웹훅 | 8 | 8 | · | · | · | · |
| 인증·SSO | 10 | 6 | 1 | 2 | · | 1 |
| 그 밖 | 24 | 19 | 1 | 3 | 1 | · |
