...
| 기준 | 값 |
|---|---|
| 원본 | [연결 상태 표](../RELEASES/draft/compatibility.md)(코드 대조 2026-09-11 · 새 설치본 실호출 확인 14) |
| 실은 연결 | 113 |
| 시스템 쌍 | 33 |
...
| Clinic ⇄ Jitsi | 1 | · | · | · | · | 1 | · |
| HIS ⇄ 환자 앱 | 1 | · | 1 | · | · | · | · |
| **합계** | **113** | 14 | 74 | 1 | 15 | 7 | 2 |

> `검증됨` 14 — 기준 커밋으로 새로 세운 설치본끼리 실제로 호출해 확인한 연결(확인일은 연결 상태 표의 확인일 칸).
