...
**구축 가이드는 새 설치본으로 한 번 따라가 봤습니다**(2026-09-13~15 · 개발 PC · GPU 없음) — 막힌 곳과 우회를 반영했지만 기준 장비 · 실데이터 규모 · 리얼 전환은 아직입니다. 확인하지 못한 명령 · 절차 · 수치는 `확인 필요(따라가기)`로 표시했고, **지어낸 절차로 채우지 않았습니다.**
