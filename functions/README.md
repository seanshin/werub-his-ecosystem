...
| **수술 · 마취 · 중환자** | HIS(수술/중환자 6묶음) | 수술 일정 · 기록 · 중환자 관리 | [HIS 메뉴](../systems/his-domains.md) · [화면](../screens/his.md) |
...
| 업무 | 맡는 시스템 | 대표 기능 | 어디서 보나 |
|---|---|---|---|
| **진단검사** | LIS · HIS | 처방 수신 → 접수·라벨 → 검체 → 결과 → **자동 검증·델타 체크** → 2차 검증 → **위험치 폐루프** → 회신 → 청구 캡처 | [LIS §4](../systems/lis.md#4-핵심-기능) · [화면](../screens/lis.md) · [임상병리 안내](../clinicians/laboratory.md) |
...
| 업무 | 맡는 시스템 | 대표 기능 | 어디서 보나 |
|---|---|---|---|
| **환자안전 · 질 지표** | HIS | 안전 사건 · 질 지표 · 감염관리. 🔴 표본이 없으면 **비율을 내지 않습니다** | [개요서 2장](../overview/02-principles.md#화면이-모른다고-말하는-아홉-가지-방식) |
| **전자서명 · 위변조 증거** | sign | 자체 PKI · 타임스탬프 · PAdES-LTA · 감사 이벤트 **봉인** · 검증 주소 | [sign §4](../systems/sign.md#4-핵심-기능) |
| **감사 · 기록 보존** | 전 시스템 | 해시체인 · 변경 차단 · 보존 기간 하한 강제 · 비상 열람 기록 | [비상 열람](detail/emergency-access.md) · [개요서 5장](../overview/05-identity-trust-standards.md) |
