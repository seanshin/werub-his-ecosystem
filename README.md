...
| [`screens/`](screens/) | **화면으로 보는 생태계**(시스템 13장 + 흐름 1장 · 캡처와 설명) | 🟡 초안 · 75장 |
| [`assets/screens/`](assets/screens/) | 화면 캡처 이미지 75장 + [캡처 목록](assets/screens/INDEX.md)(자동 생성) | 🟡 HIS 56 / 266 · 형제 시스템 6 |
