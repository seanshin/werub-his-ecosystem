...
**처음이라면 이 셋만 보세요** — [한 문장](overview/01-one-sentence.md) · [지금 상태](overview/08-status-and-preparation.md) · [화면 106장](screens/)
...
돌아가는 설치본에서 **화면 106장**을 찍어 확인했습니다(2026-09-12 · 가상 병원 데이터). 같은 "0" 이라도 **왜 0 인지에 따라 화면이 다르게 말합니다.**
...
| [`scenarios/`](scenarios/) | 데모 시나리오 4편(외래 · 응급 · 검진 · 입원→퇴원) | 🟡 초안 · 캡처 자리 51 중 **38** · 응급 시나리오는 9/9 |
...
| [`screens/`](screens/) | **화면으로 보는 생태계**(시스템 13장 + 흐름 1장 · 캡처와 설명) | 🟡 초안 · 106장 |
| [`assets/screens/`](assets/screens/) | 화면 캡처 이미지 106장 + [캡처 목록](assets/screens/INDEX.md)(자동 생성) | 🟡 HIS 77 / 266 · 형제 시스템 29 |
...
| **화면이 궁금하면** | [화면으로 보는 생태계](screens/) — 돌아가는 설치본에서 찍은 106장 |
