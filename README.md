...
| **가이드가 실측으로 채워졌다** | 따라가기 전 92곳이던 `확인 필요(따라가기)` 표시가 **24곳**으로 줄었고, 막힌 곳과 우회는 각 단계 장에 그대로 적었습니다 |
...
| [`build-guide/`](build-guide/) | **AI 기반 HIS 구축 가이드**(S0 준비 ~ S8 리얼 전환) | 🟡 초안 · **한 번 따라가 봄**(2026-09-13~16) · 남은 확인 필요 24곳 · [부록: 바꿔야 할 코드 기본값](build-guide/replace-list.md) |
