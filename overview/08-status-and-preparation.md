...
| 질문 | 지금의 답 | 근거 |
|---|---|---|
| 실제로 호출해 확인한 연결이 있나 | **없습니다. `검증됨` 0 입니다.** 모든 연결 상태는 양쪽 코드를 읽어 대조한 결과입니다 | [연결 상태](../RELEASES/draft/compatibility.md) · 판정 2026-09-11 |
...
- 센 방법: [연결 상태](../RELEASES/draft/compatibility.md)의 합계 표(판정 2026-09-11 · 양쪽 코드를 기준 커밋에서 대조 · 실제 호출 확인 없음). 연결은 방향과 목적별로 나눴습니다. 같은 두 시스템 사이에도 여러 연결이 있습니다.
