...
| 이 자료가 설명하는 버전 조합([통합 릴리즈 `2026.09`](../RELEASES/2026.09/manifest.md))과 연결 상태([연결 상태](../RELEASES/2026.09/compatibility.md)) | **AI 모델 가중치** — 기관이 모델마다 약관을 읽고 직접 받습니다 |
...
- **모든 설명은 한 버전 조합에서의 사실입니다.** 기준은 [통합 릴리즈 `2026.09` 매니페스트](../RELEASES/2026.09/manifest.md)(계측일 2026-09-11 · 기준 커밋은 [`data/base-commits.json`](../data/base-commits.json)에 고정)입니다. 다른 버전에서는 사실이 다를 수 있습니다.
