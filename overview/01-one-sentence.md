...
- **수치에는 값 · 센 방법 · 계측일을 함께 적습니다.** 계측하지 않은 것(권장 사양 · 처리량 · 응답 시간)은 "충분하다"고 쓰지 않고 "아직 계측이 없다"고 적습니다.
- **사실 확인은 생태계 자료 측 조사 기준입니다.** 각 시스템 담당의 확인과, 새 설치본으로 구축 절차를 따라가 보는 일은 아직 남아 있습니다([ROADMAP](../ROADMAP.md) P1 · P4).
