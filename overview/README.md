...
| 기준 | 값 |
|---|---|
| 버전 조합 | [통합 릴리즈 `2026.09` 매니페스트](../RELEASES/2026.09/manifest.md) · 계측일 2026-09-11 |
...
| 구축 절차 | [구축 가이드](../build-guide/) 초안 · **새 설치본으로 한 번 따라가 봄**(2026-09-13~16 · 개발 PC · GPU 없음) · 남은 확인 필요 19곳 |
