...
1. **첫 기동은 외부로 나가는 연결을 막은 상태에서 합니다.** 각 시스템의 코드와 설정 예시에 특정 설치본의 주소가 기본값으로 들어 있는 파일이 있습니다(11개 저장소 합계 245개 · 문서 제외 · 2026-09-11 기준 커밋). 바꾸지 않고 띄우면 다른 설치본으로 요청이 갈 수 있습니다([S0](../build-guide/S0-prepare.md)).
