...
| 연결 | 113개 — 검증됨 27 · 구현·미검증 61 · 설계만 1 · 미구현 15 · 중단 7 · 판정 불가 2 |
...
flowchart LR
  ...
  linkStyle 10,11,12,25 stroke:#2e7d32,stroke-width:3px
  linkStyle 5,8,15,17,18,19,20,21,22,24,26,27,28,32 stroke:#4a6fa5,stroke-width:2px
...
| 12 | PACS ⇄ sign | 2 | PACS → sign 2 | 검증됨 2 | `검증됨` |
