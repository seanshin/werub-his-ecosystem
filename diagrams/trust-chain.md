...
근거: [sign 릴리즈 요약 §1 · §2](../RELEASES/draft/systems/sign.md) · 연결과 상태는 [`RELEASES/draft/compatibility.md`](../RELEASES/draft/compatibility.md)(판정 2026-09-11 · 코드 대조 · 실제 호출 확인 없음) — 감사 이벤트 연결은 목적 칸에 "신뢰의 사슬"이 적힌 세 행입니다
